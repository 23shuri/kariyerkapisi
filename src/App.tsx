    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col font-sans text-slate-800">
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                  ...
                  <p className="mt-4 text-sm text-slate-500 leading-relaxed">
                    Kariyer Atlası, modüler mimarisi sayesinde tamamen parametrik olarak tasarlanmıştır. 
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-xs text-slate-400">
          <p>&copy; {new Date().getFullYear()} Kariyer Atlası - Yapay Zeka Tabanlı Akıllı Eşleştirme Sistemi. Tüm hakları saklıdır.</p>
        </div>
      </footer>
