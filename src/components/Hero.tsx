      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            ...
            <span>Kariyer Atlası Akıllı Eşleştirme Motoru V3.0 Aktif</span>
          </motion.div>
          ...
          >
            Klasik anahtar kelime aramalarını unutun. Kariyer Atlası, özgeçmişinizi derinlemesine analiz eder, iş ilanlarıyla yeteneklerinizi %99'a varan doğrulukla eşleştirir.
          </motion.p>
