...
export const EmployerDashboard: React.FC<EmployerDashboardProps> = ({ currentUser, onNotificationChange }) => {
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If user selected a new avatar, convert to base64
      if (avatarFile) {
      ...
      console.log('[Profile] Saving with avatarUrl:', avatarUrl ? 'Updated' : 'No change');
      ...
      if (response.ok) {
        ...
        // Update parent - simple refresh to update header name and avatar
          ...
          <div className="flex items-center gap-4">
            {currentUser.avatarUrl ? (
              <img 
                ...
                className="h-12 w-12 rounded-xl object-cover ring-2 ring-emerald-50"
